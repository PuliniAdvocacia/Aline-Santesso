...
// Componente do Logo do WhatsApp
    ...
    <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-md border-b border-rose-100 py-3 shadow-sm' : 'bg-transparent py-8'}`}>
      <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
        <header className="flex flex-col">
          ...
          <span className="text-[9px] uppercase tracking-[0.4em] text-rose-400 font-bold">Direito Imobiliário e Família</span>
        </header>
...
export default function App() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Quando o casal está de acordo sobre a partilha de bens e pensão, e não existem filhos menores ou incapazes, o divórcio pode ser feito diretamente no cartório através de escritura pública."
    },
    {
      question: "O que é planejamento sucessório?",
      answer: "É um conjunto de estratégias jurídicas para organizar a transferência do patrimônio ainda em vida, reduzindo custos tributários e evitando conflitos familiares."
    }
  ];
    ...
    <div className="min-h-screen bg-white selection:bg-rose-100 selection:text-rose-900">
          ...
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-5 gap-16 items-center">
            ...
            <div className="md:col-span-3 space-y-10 reveal-left">
              ...
              <div className="space-y-6 text-slate-600 font-light text-xl leading-relaxed">
                <p>
                  Minha missão é oferecer segurança jurídica através de um atendimento próximo, transparente e focado na proteção do seu patrimônio.
                </p>
                <blockquote className="p-8 bg-slate-50 rounded-3xl italic font-serif text-slate-800 border-l-4 border-rose-500 text-lg">
                  "Acredito em uma advocacia que previne problemas e resolve conflitos de forma inteligente."
                </blockquote>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-10 text-center relative z-10">
            <div className="max-w-4xl mx-auto space-y-16">
              <header className="space-y-6 reveal">
                ...
                <p className="text-slate-400 text-xl font-light">Agende sua consultoria diretamente pelos canais abaixo.</p>
              </header>
              ...
              <div className="grid md:grid-cols-2 gap-8 reveal">
                  <a 
                    ...
                    className="flex flex-col items-center gap-6 p-10 bg-white/5 rounded-[3rem] border border-white/10 hover:bg-[#25D366] transition-all group outline-none"
                  >
      ...
      <footer className="py-12 px-10 border-t border-slate-50 reveal">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">© 2026 • Aline Santesso Pulini</p>
        </div>
      </footer>

      <a 
        href="https://wa.me/5517992116720" 
        className="fixed bottom-8 right-8 z-[999] bg-[#25D366] text-white p-6 rounded-full shadow-[0_30px_60px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all group outline-none"
